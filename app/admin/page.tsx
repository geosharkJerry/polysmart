...
import { BillingProfile, SettlementLedger } from "@/lib/types";
...
export default function AdminPage() {
  ...
  useEffect(() => {
    const boot = async () => {
      const [usersRes, settlementRes] = await Promise.all([
      ...
      <section className="mx-auto max-w-6xl px-6 pb-14 pt-10">
        <div className="rounded-3xl border border-sky-100 bg-white p-7 shadow-sm">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Unified operations for subscriptions, settlement frequencies, revenue attribution, and matrix execution health.
          </p>
