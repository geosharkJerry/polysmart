...
export function AdminPaymentsWorkspace(props: { admin: { email: string; role: string } }) {
  const { admin } = props;
  ...
  return (
    <AdminShell
      admin={admin}
      title="Payments and Settlement Workspace"
      description="Operate recharge confirmation, PSC revenue closeout, and settlement evidence from one commercial operations workspace."
      status={status}
      badges={[
      ...
      statusNote="Commercial reconciliation, subscription crediting, and managed-commission closeout are unified here before revenue is considered production-ready."
    ...
    >
      ...
      <WorkspaceCluster
        eyebrow="Commercial closeout"
        title="Recharge, revenue, and settlement evidence"
        description="This workspace keeps Stripe recharge confirmation, PSC revenue closeout, and downstream ledger evidence in one operating flow."
        mt={7}
      >
        <div className="grid gap-6 xl:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
          <div className="grid gap-6">
            <PanelSection
              ...
              description="Reconcile a Stripe checkout session against the internal payment session ledger before points are considered confirmed."
              eyebrow="Recharge lane"
            >
              <SettingsInset eyebrow="Reconciliation state" title="Stripe session validator" description={stripeStatus}>
                <FormGrid mt={1} columns={{ base: 1, lg: 2 }} gap={3}>
                  <FormField label="Polysmart payment session ID" helperText="Example: PAY-... from the recharge session ledger.">
                  ...
                  <FormField label="Stripe checkout session ID" helperText="Example: cs_live_... from Stripe Dashboard or Checkout redirect.">
                ...
                <ActionBar mt={4} status={<span className="text-xs text-slate-500 dark:text-slate-400">Manual reconciliation validates amount, currency, and paid status before crediting points.</span>}>
            ...
            <PanelSection
              ...
              description="Recompute PSC revenue and inspect the net profit view produced from current settlement records."
          ...
          <div className="grid gap-6">
            <PanelSection
              ...
              description="Track recharge volume, recognized platform revenue, and the latest reconciliation signals without leaving the payments lane."
            ...
            <PanelSection
              ...
              description="Review settlement rows that feed PSC reporting and managed-revenue tracking."
              eyebrow="Ledger lane"
            >
            ...
            <PanelSection
              ...
              description="Inspect active recharge sessions and the points they are expected to credit."
